...
static int tps6591x_get_voltage_selector(struct regulator_dev *rdev,
...
static int tps65911_set_voltage(struct regulator_dev *dev,
				int min_uV, int max_uV)
{
	struct tps65910_reg *pmic = rdev_get_drvdata(dev);
	int reg, id = rdev_get_id(dev);
...
static struct regulator_ops tps65911_ops = {
	...
	.set_voltage		= tps65911_set_voltage,
