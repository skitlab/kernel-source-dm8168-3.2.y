...
enum sf_channel_filter_ctrl {
	SF_FILTER_DISABLE = 0,
	SF_FILTER_BYPASS,
	SF_FILTER_SD_MODE,
	SF_FILTER_ED_MODE,
	SF_FILTER_HD_MODE,
	SF_FILTER_TRUE_HD_MODE
};
...
struct vps_platform_data {
	...
	int (*hd_channel_ctrl)(enum sf_channel_filter_ctrl);
	int (*sd_channel_ctrl)(enum sd_channel_filter_ctrl);
};
