...
extern void usb_nop_xceiv_register(u8 id);
extern void usb_nop_xceiv_unregister(u8 id);
#else
static inline void usb_nop_xceiv_register(u8 id)
{
}

static inline void usb_nop_xceiv_unregister(u8 id)
{
}
#endif
...
extern struct otg_transceiver *otg_get_transceiver(u8 id);
extern void otg_put_transceiver(struct otg_transceiver *);
extern const char *otg_state_string(enum usb_otg_state state);
#else
static inline struct otg_transceiver *otg_get_transceiver(u8 id)
{
	return NULL;
}
